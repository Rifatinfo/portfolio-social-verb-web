    ...
    <div className="mt-4 -mb-20 shadow-[0px_-4px_10px_rgba(0,0,0,0.1)] bg-white text-[#C73450]">
      <footer>
        <div className="max-w-7xl  flex flex-col mx-auto  lg:flex-row md:h-[60px]">
          ...
          <div className="md:mr-90 font-semibold self-center py-6 space-y-4 text-end sm:flex sm:space-y-0 justify-center sm:space-x-4  lg:justify-center">
            <p>Copyright © {new Date().getFullYear()} - Social Verb</p>
          </div>
          <div className="flex flex-col justify-center pt-6 lg:pt-0 text-3xl mb-1">
