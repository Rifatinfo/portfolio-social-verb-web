                ...
                <div className=' md:w-1/2 md:flex justify-end items-center'>
                    <div className="w-full  h-[490px] max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
                        ...
                        <div className="my-6 space-y-4">
                            <button aria-label="Login with Google" type="button" className="hover:bg-[#C73450] hover:border-[#C73450] hover:text-white flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
