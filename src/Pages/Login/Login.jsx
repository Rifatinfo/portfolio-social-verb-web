                ...
                <div>
                    <div className="w-full  h-[490px] max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
                        ...
                        <p className="text-sm text-center dark:text-gray-600 font-semibold">Dont have account?
                            <Link to="/signup">
                                <a href="#" rel="noopener noreferrer" className="focus:underline hover:underline hover:text-[#C73450]">Sign up here</a>
                            </Link>
                        </p>
                        <div className="my-6 space-y-4">
                            <button onClick={googleSignIn} aria-label="Login with Google" type="button" className="hover:bg-[#C73450] hover:border-[#C73450] hover:text-white flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                        ...
                        <form noValidate="" action="" className="space-y-8">
                            ...
                            <button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-[#C73450]  text-white">Sign in</button>
                        </form>
                    </div>
                </div>
            </div>
