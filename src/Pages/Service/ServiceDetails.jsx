    ...
    return (
        <div className="mt-[74px]  max-w-7xl mx-auto">
                   ...
                   bg-clip-text"
                    ...
                    <div className="join join-vertical bg-base-100 md:w-3/4 w-full">
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            ...
                            <div className="collapse-title font-semibold text-[#C73450] text-lg">Social Media Marketing</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            ...
                            <div className="collapse-title font-semibold text-[#C73450] text-lg">Search Engine Optimization (SEO)</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg"> Pay-Per-Click Advertising (PPC) </div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg"> Content Marketing ✍️</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg">  Email Marketing 📩</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg"> Conversion Rate Optimization (CRO) 🚀</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg"> Influencer Marketing 🤝</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg">Affiliate Marketing 💰</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg"> Online Reputation Management (ORM) ⭐</div>
                        ...
                        <div className="collapse collapse-arrow join-item border-base-300 border">
                            <input type="radio" name="my-accordion-4" />
                            <div className="collapse-title font-semibold text-[#C73450] text-lg"> Video Marketing 🎬</div>
            ...
            <div className="flex items-center justify-center">
                <button className=" font-semibold relative overflow-hidden group border-2 border-[#C73450] text-[#C73450] rounded-md flex  justify-center gap-2 py-2 px-4 transition-all duration-300 ease-in-out">
